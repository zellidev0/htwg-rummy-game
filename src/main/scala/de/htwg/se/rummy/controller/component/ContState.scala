...
object ContState extends Enumeration {
  ...
  INSERTED_NAME, P_WON, P_DOES_NOT_OWN_TILE, CANT_MOVE_THIS_TILE,
  PLAYER_REMOVED, UNDO_LAY_DOWN_TILE, BAG_IS_EMPTY,
  LOAD_FILE, STORE_FILE, COULD_NOT_LOAD_FILE = Value
