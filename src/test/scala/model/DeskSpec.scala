...
class DeskSpec extends WordSpec with Matchers {
  ...
  "A Desk" when {
    ...
    "created with 2 and gets added 3 more players" should {
      var desk = deskComp.Desk(Set[PlayerInterface](Player("Name1", 0, Board(SortedSet[TileInterface]())), Player("Name2", 1, Board(SortedSet[TileInterface]()))),
        Set(Tile(1, Color.RED, 0), Tile(2, Color.RED, 0)), Set[SortedSet[TileInterface]]())
    ...
    "created with 2 and removes one player" should {
      var desk = deskComp.Desk(Set[PlayerInterface](Player("Name1", 0, Board(SortedSet[TileInterface]()), State.TURN), Player("Name2", 1, Board(SortedSet[TileInterface]()))),
        Set(Tile(1, Color.RED, 0), Tile(2, Color.RED, 0)), Set[SortedSet[TileInterface]]())
    ...
    "created with empty players" should {
      var desk = deskComp.Desk(Set[PlayerInterface](), Set(Tile(1, Color.RED, 0), Tile(2, Color.RED, 0)), Set[SortedSet[TileInterface]]())
      "have size 0" in {
    ...
    "user takes tile from bag" should {
      ...
      var desk = deskComp.Desk(players, Set[TileInterface](Tile(1, Color.RED, 0), Tile(1, Color.RED, 1)), Set[SortedSet[TileInterface]]())
    ...
    "two players switch turn, -> its player" should {
      ...
      var desk = deskComp.Desk(Set(player1, player2), Set[TileInterface](), Set[SortedSet[TileInterface]]())
    ...
    "check table" should {
      ...
      var desk = deskComp.Desk(players, Set[TileInterface](), setOfCorrectStreets)
      "be true when setOfCorrectStreets" in {
        desk.checkTable() should be(true)
      }
      "be true when setOfCorrectPairs" in {
        desk = deskComp.Desk(players, Set[TileInterface](), setOfCorrectPairs)
        desk.checkTable() should be(true)
      }
      "be true when setOfWrongStreets" in {
        desk = deskComp.Desk(players, Set[TileInterface](), setOfWrongStreets)
        desk.checkTable() should be(false)
      }
      "be true when setOfWrongPairs" in {
        desk = deskComp.Desk(players, Set[TileInterface](), setOfWrongPairs)
        desk.checkTable() should be(false)
      }
    }
    "check street" should {
    ...
    "check pair" should {
      ...
      val setOfWrongPairs =
        Set(SortedSet[TileInterface](Tile(10, Color.GREEN, 0), Tile(10, Color.GREEN, 1), Tile(10, Color.BLUE, 0)), // Pair of 3 where 2 same
          SortedSet[TileInterface](Tile(13, Color.YELLOW, 0), Tile(13, Color.GREEN, 0))) // Pair of 2
      val players = Set[PlayerInterface](Player("Name1", 0, Board(SortedSet[TileInterface]()), state = State.TURN), Player("Name2", 1, Board(SortedSet[TileInterface]())))
      var desk = deskComp.Desk(players, Set[TileInterface](), setOfCorrectPairs)
    ...
    "one player puts last tile down" should {
      ...
      var desk = deskComp.Desk(Set[PlayerInterface](Player("Name1", 0, Board(SortedSet[TileInterface](tile)), state = State.TURN), Player("Name2", 1, Board(SortedSet[TileInterface]()))), Set[TileInterface](), Set[SortedSet[TileInterface]]())
    ...
    "move a tile form one set to another" should {
      ...
      var desk = deskComp.Desk(players, Set[TileInterface](), Set[SortedSet[TileInterface]](SortedSet(Tile(1, Color.BLUE, 0), Tile(2, Color.BLUE, 0), tile2), SortedSet()))
      desk = desk.putDownTile(desk.currentP, tile)
    ...
    "taking up a tile" should {
      ...
      val tile2 = Tile(3, Color.BLUE, 0)
      val players = Set[PlayerInterface](Player("Name1", 0, Board(SortedSet[TileInterface](tile)), state = State.TURN))
      var desk = deskComp.Desk(players, Set[TileInterface](), Set[SortedSet[TileInterface]](SortedSet(tile2), SortedSet()))
    ...
    "adding to bag" should {
      ...
      var desk = deskComp.Desk(players, Set[TileInterface](), Set[SortedSet[TileInterface]]())
