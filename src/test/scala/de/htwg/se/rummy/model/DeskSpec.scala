...
//      var desk = deskBaseImpl.Desk(Set[PlayerInterface](Player("Name1", 0, Board(SortedSet[TileInterface]()), PlayerState.TURN), Player("Name2", 1, Board(SortedSet[TileInterface]()))),
//        Set(Tile(1, Color.RED, 0), Tile(2, Color.RED, 0)), Set[SortedSet[TileInterface]]())
...
//      val players = Set[PlayerInterface](Player("Name1", 0, Board(SortedSet[TileInterface](Tile(1, Color.RED, 0), Tile(1, Color.RED, 1))), state = PlayerState.TURN))
...
//        desk.players.exists(p => p.number == player1.number && p.state == PlayerState.WAIT) should be(true)
//        desk.getPreviousPlayer.number should be(player1.number)
//      }
//      "have status TURN (next)" in {
//        desk.players.exists(p => p.number == player2.number && p.state == PlayerState.TURN) should be(true)
//      }
//    }
//    "check table" should {
